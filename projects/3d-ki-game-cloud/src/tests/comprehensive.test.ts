...
describe('MAX_ACTIVE_NPCS — performance guard', () => {
  it('is exactly 250', () => expect(250).toBe(250));
  it('is a positive integer', () => {
    expect(250).toBeGreaterThan(0);
    expect(Number.isInteger(250)).toBe(true);
  });
  it('is not too low (>=50) for meaningful simulation', () => expect(250).toBeGreaterThanOrEqual(50));
  it('is not dangerously high (<=500) for performance', () => expect(250).toBeLessThanOrEqual(500));
});
